...
state_type{S,A,O}(t::Type{IPOMDP{S,A,O}}) = S
state_type{S,A,O}(t::Type{RPOMDP{S,A,O}}) = S
state_type{S,A,O}(t::Type{RIPOMDP{S,A,O}}) = S
...
action_type{S,A,O}(t::Type{IPOMDP{S,A,O}}) = A
action_type{S,A,O}(t::Type{RPOMDP{S,A,O}}) = A
action_type{S,A,O}(t::Type{RIPOMDP{S,A,O}}) = A
...
obs_type{S,A,O}(t::Type{IPOMDP{S,A,O}}) = O
obs_type{S,A,O}(t::Type{RPOMDP{S,A,O}}) = O
obs_type{S,A,O}(t::Type{RIPOMDP{S,A,O}}) = O
